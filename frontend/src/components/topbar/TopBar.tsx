...
export default function TopBar() {
  const { mode, activeConversation } = useKronxStore()
  ...
  return (
    <header className="topbar">
      <div className="topbar-left">
        ...
        >
          {modeConfig.labelSw} · {modeConfig.labelEn}
        </div>
        <span className="topbar-subtitle">
          {conv ? conv.title : 'Mazungumzo mapya · New conversation'}
        </span>
      </div>

      <div className="topbar-right">
        <button className="icon-btn" title="Kumbukumbu · Memory" aria-label="Memory">
        ...
        <button className="icon-btn" title="Malengo · Goals" aria-label="Goals">
          <svg width={15} height={15} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8}>
        ...
        <button className="icon-btn" title="Mipangilio · Settings" aria-label="Settings">
          <svg width={15} height={15} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8}>
